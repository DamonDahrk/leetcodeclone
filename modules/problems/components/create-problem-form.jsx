...
const problemSchema = z.object({
  ...
  testCases: z
    .array( // you can have mutliple array of objects for test cases
      z.object({
        input: z.string().min(1, "Input is required"),
        output: z.string().min(1, "Output is required"),
      })
    ) //you need atleast one testcase
  ...
  examples: z.object({
    ...
    JAVA: z.object({
      ...
      output: z.string().min(1, "Output is required"),
      explanation: z.string().optional(),
    }),   //doing same for Js Java and Python
  }),
...
const CreateProblemForm = () => {
  ...
  const [sampleType, setSampleType] = useState("DP"); //use states for sample problem types
  ...
  }); // const form was created using useForm from react hook form there we are setting up 
  // zod resolver for validation and default values for the form fields
  ...
  //You are destructuring useful tools from the form object returned by useForm().
  ...
  //This form has a field called testCases which is an array,
  //  and I want to manage it dynamically.
  ...
  const onSubmit = async (values) => {
    try {
      setIsLoading(true);   //call our backend api to create a problem
  ...
  //This function:
  //picks a sample problem template
  //injects it into your form
  //correctly updates dynamic arrays (tags, testCases)
  //resets the rest of the form in one shot
